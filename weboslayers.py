...
webos_layers = [
('bitbake',               -1, 'git://github.com/openembedded/bitbake.git',              'commit=', ''),
('meta',                   5, 'git://github.com/openembedded/oe-core.git',              'commit=', ''),
('meta-oe',                6, 'git://github.com/openembedded/meta-oe.git',              'commit=', ''),
('meta-networking',        6, 'git://github.com/openembedded/meta-oe.git',              '', ''),

#('meta-webos-backports',   9, 'git://github.com/openwebos/meta-webos-backports.git',    'commit=', ''),
('meta-webos',            10, 'git://github.com/openwebos/meta-webos.git',              'commit=', ''),
('meta-oe',                6, 'git://github.com/openwebos/meta-oe.git',                 'commit=', ''),
]
